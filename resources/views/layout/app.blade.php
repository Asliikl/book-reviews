...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .filter-container {
            @apply mb-4 flex space-x-2 rounded-md bg-sky-900 p-2;
        }

        .filter-item {
            @apply flex w-full items-center justify-center rounded-md px-4 py-2 text-center text-sm font-medium text-white hover:bg-white hover:text-gray-800 transition-colors;
        }

        .filter-item-active {
            @apply bg-gray-50 text-gray-800 shadow-sm flex w-full items-center justify-center rounded-md px-4 py-2 text-center text-sm font-medium;
        }
        ...
        .book-title {
            @apply text-lg font-semibold text-rose-500 hover:text-rose-600;
        }
        ...
        .reset-link {
            @apply text-black underline decoration-red-500;
        }
    </style>
